...
<h2>
Q: Printing triangle downwards (Five star to One star). </h2>
...
<div style="width: 100%; overflow: hidden;">
    ...
    <input type="radio" class="radiobox" name="option" value="option1"> <br>
        int term=5;  <br>
        for(int i=1;i<=term;i++) { <br>  
        &nbsp &nbsp for(int j=term;j>=i;j--) {  <br>
        &nbsp &nbsp &nbsp &nbsp System.out.print("* ");  <br>
        &nbsp &nbsp }  <br>
    ...
    <input type="radio" class="radiobox" name="option" value="option3"> <br>
        int term=5;  <br>
        for(int i=1;i<=term-1;i++) { <br>  
        &nbsp &nbsp for(int j=term-1;j>=i;j++) { <br> 
        &nbsp &nbsp &nbsp &nbsp System.out.print("* ");  <br>
        &nbsp &nbsp }  <br>
        &nbsp &nbsp System.out.println(); <br>
        }<br>
